...
var points = textToPoints("史晓璇", 30, "Anton");
var points2 = textToPoints("生日快乐!", 30, "Anton");
    ...
    if (this.vy >= 0) {
      ...
      if (this.title) {
        ...
        for (var i = 0; i < points.length; i++) {
          ...
          let particle = new TitleParticle(this.x, this.y, v.x, v.y);
        ...
        for (var i = 0; i < points2.length; i++) {
          ...
          var v = {
            ...
            y: (p.y - 30) * scale + (Math.random() - 0.5) * 0.1
          }
          let particle = new TitleParticle(this.x, this.y, v.x, v.y);
          titleParticles.push(particle);
        }
